# Generated by Django 3.2.8 on 2022-06-29 10:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('airline_company_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.airline_companie')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.user', unique=True)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='airline_companie',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.user', unique=True),
        ),
        migrations.CreateModel(
            name='Adminstrator',
            fields=[
